        ...
        <ProductCart>
            <div className={"desktop"}>
                ...
                <div className={"quantity"}>
                    <button onClick={() => decreaseQuantity(product)} data-testid={`decrease-quantity-${product.id}`}>
                        <HiMinusSmall/></button>
                    <span>{product.quantity}</span>
                    <button onClick={() => increaseQuantity(product)} data-testid={`increase-quantity-${product.id}`}>
